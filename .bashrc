...
export PATH="~/Desktop/bash-scripting-course/scripts:/Users/rod/.dotfiles/scripts:/usr/local/opt/tailscale/bin:/usr/local/Cellar/tailscale/1.82.4/bin:/Applications/IntelliJ IDEA.app/Contents/MacOS:$PATH"
export EDITOR="vim"
# tput colours
